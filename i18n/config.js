    ...
    messages: {
        fr: {
            ...
            modal: {
                ...
                textIconColor: "Couleur du texte et des icônes",
                colorMode: "Mode de couleur",
                whiteText: "Texte et icônes blancs",
                blackText: "Text et icônes noirs",
                bgSecondaryColor: "Couleur d'arrière-plan",
            ...
            toast: {
                ...
                stoppedListening: "Arrêt de l'écoute 🎤.",
                ...
                speechSynthesisUnsupported: "Synthesis vocale non prise en charge",
                noTextToRead: "Pas de texte à lire",
        ...
        es: {
            ...
            modal: {
                ...
                textIconColor: "Color de texto e íconos",
                colorMode: "Modo de color",
                whiteText: "Texto e íconos blancos",
                blackText: "Texto e íconos negros",
                bgSecondaryColor: "Color de fondo",
            ...
            toast: {
                ...
                stoppedListening: "Escucha detenida 🎤.",
                transcribed: "¡Voz transcrita con éxito!",
                speechRecognition: "El reconocimiento de voz no es compatible con este navegador.",
                speechSynthesisUnsupported: "Síntesis de voz no compatible",
                noTextToRead: "No hay texto para leer",
        ...
        pt: {
            ...
            modal: {
                ...
                textIconColor: "Cor do texto e dos ícones",
                colorMode: "Modo de cor",
                whiteText: "Texto e ícones brancos",
                blackText: "Texto e ícones pretos",
                bgSecondaryColor: "Cor de fundo",
            ...
            toast: {
                ...
                stoppedListening: "Escuta encerrada 🎤.",
                transcribed: "Fala transcrita com sucesso!",
                speechRecognition: "Reconhecimento de voz não é compatível com este navegador.",
                speechSynthesisUnsupported: "Síntese de fala não suportada",
                noTextToRead: "Nenhum texto para ler",
        ...
        en: {
            ...
            modal: {
                ...
                whiteText: "White text and icons",
                blackText: "Black text and icons",
                bgSecondaryColor: "Background color",
            ...
            toast: {
                ...
                speechSynthesisUnsupported: "Speech synthesis unsupported",
        ...
        it: {
            ...
            modal: {
                ...
                textIconColor: "Colore del testo e delle icone",
                colorMode: "Modalità colore",
                whiteText: "Testo e icone bianchi",
                blackText: "Testo e icone neri",
                bgSecondaryColor: "Colore di sfondo",
            ...
            toast: {
                ...
                stoppedListening: "Ascolto interrotto 🎤.",
                transcribed: "Voce trascritta con successo!",
                speechRecognition: "Il riconoscimento vocale non è supportato da questo browser.",
                speechSynthesisUnsupported: "Sintesi vocale non supportata",
                noTextToRead: "Nessun testo da leggere",
        ...
        sv: {
            ...
            modal: {
                ...
                textIconColor: "Text- och ikonfärg",
                colorMode: "Färgläge",
                whiteText: "Vita texter och ikoner",
                blackText: "Svarta texter och ikoner",
                bgSecondaryColor: "Bakgrundsfärg",
            ...
            toast: {
                ...
                stoppedListening: "Lyssningen stoppades 🎤.",
                transcribed: "Rösten transkriberades framgångsrikt!",
                speechRecognition: "Röstigenkänning stöds inte i den här webbläsaren.",
                speechSynthesisUnsupported: "Talsyntes stöds inte",
                noTextToRead: "Ingen text att läsa",
        ...
        ro: {
            ...
            modal: {
                ...
                textIconColor: "Culoare text și pictograme",
                colorMode: "Mod culoare",
                whiteText: "Text și pictograme albe",
                blackText: "Text și pictograme negre",
                bgSecondaryColor: "Culoare de fundal",
                resetDefault: "Resetează la valorile implicite",
                confirm: "Confirmi?",
                yes: "Da",
                no: "Nu",
            ...
            toast: {
                ...
                stoppedListening: "Ascultarea a fost oprită 🎤.",
                transcribed: "Vocea a fost transcrisă cu succes!",
                speechRecognition: "Recunoașterea vocală nu este compatibilă cu acest browser.",
                speechSynthesisUnsupported: "Sinteza vocală neacceptată",
                noTextToRead: "Niciun text de citit",
        ...
        hy: {
            ...
            homepage: {
                ...
                app: "Անձնական նշումների հավելված, որտեղ կարող եք գրել կամ խոսքի միջոցով թելադրել նշումներ և միացնել մկնիկի հետքը՝ տեսողական արձագանքի համար։",
                actions: "Ստեղծեք, խմբագրեք կամ ջնջեք նշումներ՝ դասավորված ըստ ստեղծման կամ թարմացման ամսաթվի։",
                calendar: "Հեշտությամբ համաժամեցրեք ընտրված նշումները ձեր Google Օրացույցի հետ, որտեղ դրանք հայտնվում են որպես խմբագրելի իրադարձություններ։",
                organize: "Բջջայինում՝ սահեցրեք ձախ՝ արագ համաժամեցնելու կամ ջնջելու համար՝ առանց բացելու։",
                access: "Դիտեք մեր Գաղտնիության քաղաքականությունը և Օգտագործման պայմանները ցանկացած պահին հավելվածում։"
            },
            register: {
                subscription: "Անվճար բաժանորդագրություն",
                subscribed: "Արդեն ունե՞ք հաշիվ։",
                login: "Մուտք գործել",
                account: "ձեր հաշիվ",
                email: "Էլ․ հասցե",
                password: "Գաղտնաբառ (նվազագույնը 8 նիշ)",
                subscribe: "Գրանցվել"
            },
            login: {
                connection: "Մուտք գործեք ձեր հաշիվ",
                subscribed: "Չունե՞ք հաշիվ։",
                creation: "Գրանցվել",
                email: "Էլ․ հասցե",
                password: "Գաղտնաբառ",
                forgottenPassword: "Մոռացե՞լ եք գաղտնաբառը",
                connect: "Մուտք"
            },
            forgotPassword: {
                forgotten: "Մոռացե՞լ եք ձեր գաղտնաբառը։",
                enterEmail: "Մուտքագրեք ձեր էլ․ հասցեն՝ վերականգնման հղումը ստանալու համար",
            ...
            notes: {
                text: "༄ Գրեք ձեր տեքստը այստեղ... ༄",
                nothing: "Դեռ ոչինչ չկա...",
                upcoming: "Հաջորդը",
                tomorrow: "Վաղը",
                today: "Այսօր",
                yesterday: "Երեկ",
            ...
            tooltip: {
                createNote: "Ստեղծել նոր նշում",
                deleteNote: "Ջնջել նշումը",
                dictateNote: "Թելադրել նշումը",
                listenNote: "Լսել նշումը",
                activate: "Միացնել մկնիկի հետքը",
                deactivate: "Անջատել մկնիկի հետքը",
                logout: "Դուրս գալ"
            },
            modal: {
                ...
                textIconColor: "Տեքստի և պատկերակների գույնը",
                colorMode: "Գունային ռեժիմ",
                whiteText: "Սպիտակ տեքստ և պատկերակներ",
                blackText: "Սև տեքստ և պատկերակներ",
                bgSecondaryColor: "Հետնամասի գույնը",
                resetDefault: "Վերականգնել լռելյայնը",
                confirm: "Հաստատե՞լ",
                yes: "Այո",
                no: "Ոչ",
                ...
                privacy: {
                    ...
                    collect: "1. Ինչ տեղեկություններ ենք մենք հավաքում",
                    choice: "Եթե միացնում եք Google Օրացույցը, մենք մուտք ենք խնդրում ձեր Google հաշվի OAuth միջոցով՝ օգտագործելով հետևյալ թույլտվությունը՝ https://www.googleapis.com/auth/calendar.events",
                    data: "2. Ինչպես ենք օգտագործում ձեր տվյալները",
                    permission: "Այս թույլտվությունը օգտագործվում է միայն ձեր անձնական նշումները ներկայացնող օրացույցի իրադարձությունները ստեղծելու, թարմացնելու կամ ջնջելու համար։ Մենք չենք մուտք գործում կամ վերլուծում ձեր օրացույցի այլ իրադարձությունները։",
                    storage: "3. Տվյալների պահպանում և պաշտպանություն",
                    token: "OAuth նշանները պահպանվում են անվտանգ՝ կոդավորված ձևով մեր սերվերներում և փոխանցվում են միայն HTTPS միջոցով։ Դրանք հասանելի են միայն թույլատրված սերվերային ֆունկցիաներին։ Մենք չենք կիսվում ձեր տվյալներով երրորդ կողմերի հետ։",
                    retention: "4. Տվյալների պահպանման և ջնջման կարգը",
                    deletion: "Մենք պահպանում ենք ձեր OAuth նշանները, քանի դեռ ձեր հաշիվը միացված է Google Օրացույցին։ Կարող եք ցանկացած պահի անջատել՝ նշանները անմիջապես ջնջելու համար։ Կարող եք նաև դիմել մեզ՝ ձեր բոլոր տվյալների ջնջման համար։",
                    compliance: "5. Սահմանափակ օգտագործման համապատասխանություն",
                    requirements: "Մեր հավելվածը խստորեն հետևում է Google-ի սահմանափակ օգտագործման պահանջներին՝ մուտք գործելով միայն այն տվյալներին, որոնք անհրաժեշտ են ձեր պահանջած գործառույթների համար։ Մենք երբեք չենք օգտագործում ձեր տվյալները գովազդի կամ վերլուծության նպատակներով։",
                    contact: "6. Կապ",
                    questions: "Եթե ունեք հարցեր մեր քաղաքականության կամ ձեր տվյալների վերաբերյալ, կարող եք կապ հաստատել մեզ հետ՝",
                    back: "Վերադառնալ"
                },
                terms: {
                    title: "Պայմաններ",
                    use: "Օգտագործելով Notes հավելվածը՝ դուք համաձայնվում եք չչարաշահել ծառայությունը կամ դրա հնարավորությունները։",
                    features: "Մենք իրավունք ենք պահպանում ցանկացած պահի փոփոխել կամ դադարեցնել գործառույթները։ Հավելվածի շարունակական օգտագործումը նշանակում է, որ ընդունում եք փոփոխությունները։",
                    app: "Մեր հավելվածը տրամադրվում է «ինչպես կա» սկզբունքով՝ առանց երաշխիքների։ Օգտագործումը ձեր պատասխանատվությամբ է։",
                    back: "Վերադառնալ"
                }
            },
            accessibility: {
                readNote: "Կարդալ նշումը բարձրաձայն",
                accessibility: "Մատչելի",
                highContrast: "Հակադրություն",
                reset: "Զրոյացնել"
            },
            toast: {
                note: "Նշում",
                ...
                passwordChange: "Գաղտնաբառը հաջողությամբ փոխվել է!",
                linkError: "Անվավեր կամ ժամկետանց հղում",
                resetLink: "Վերականգնման հղումը ուղարկվել է ձեր էլ․ փոստին",
                noteDeletion: "Նշումը հաջողությամբ ջնջվել է!",
                deletionError: "Նշումը ջնջելու սխալ",
                speechError: "Խոսքի ճանաչման սխալ։",
                noSpeech: "Խոսք չի հայտնաբերվել։ Խնդրում ենք կրկին փորձել։",
                audioError: "Միկրոֆոն չի հայտնաբերվել։",
                permissionError: "Միկրոֆոնի հասանելիությունը արգելափակվել է։",
                listening: "Լսում եմ... 🎤 Խնդրում ենք խոսել հստակ։",
                stoppedListening: "Լսելը դադարեցվեց 🎤:",
                transcribed: "Խոսքը հաջողությամբ վերածվեց տեքստի։",
                speechRecognition: "Խոսքի ճանաչումը չի աջակցվում այս դիտարկչում։",
                speechSynthesisUnsupported: "Խոսքի ձայնային ընթերցումը չի աջակցվում։",
                noTextToRead: "Չկա կարդալու տեքստ։",
                readingNote: "Կարդում եմ նշումը...",
                saving: "Պահպանում է...",
                ...
                calendar: {
                    ...
                    calendarConnected: "միացված է",
                    checkEvents: "Ստուգել իրադարձությունները",
                    reconnect: "Վերամիացնել Օրացույցը",
                    confirmation: "Ձեր Google Օրացույցը միացվել է Memo's Notes հավելվածին։",
                    toNotes: "Գնալ նշումներ",
                    connectFirst: "Խնդրում ենք նախ միանալ Google Օրացույցին։",
                    connectionFailed: "Միացումը ձախողվեց",
                    tryAgain: "Կրկին փորձել",
                    expired: "Օրացույցի միացումը ժամկետանց է։ Վերամիացեք։",
                    sync: "Նշումը համաժամեցվել է Google Օրացույցի հետ",
                    syncToCalendar: "Համաժամեցնել Օրացույցի հետ",
                    failed: "Նշումը համաժամեցնել չհաջողվեց՝ ",
                    connectionFailed: "Չհաջողվեց միանալ Google Օրացույցին։ Կրկին փորձեք։",
                    checkFailed: "Չհաջողվեց ստուգել օրացույցի իրադարձությունները՝ ",
                    notConnected: "Օրացույցը միացված չէ",
                    token: "Google Օրացույցի նշանը ժամկետանց է։ Վերամիացեք։",
                    refreshToken: "Բացակայում է թարմացման նշանը։ Վերահաստատեք մուտքը։",
                    success: "Հաջողությամբ միացված է Google Օրացույցին!",
                    updated: "Նշումը թարմացվել է Google Օրացույցում!",
                    alreadySynced: "Նշումը արդեն համաժամեցվել է։",
                    error: "Սխալ",
                    eventsFound: "Գտնվել է {count} իրադարձություն Google Օրացույցում"
                }
            },
            common: {
            ...
            pwa: {
                iosPrompt: "Հավելվածը տեղադրելու համար սեղմեք «Share → Add to Home Screen»",
                dismiss: "Փակել"
            },
            easter: "Շնորհավոր Զատիկ!",
            halloween: "Շնորհավոր Հելոուին!",
            xmas: "Շնորհավոր Սուրբ Ծնունդ!",
            newYear: "Շնորհավոր Նոր Տարի!"
        }
    },
}));