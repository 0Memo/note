        ...
        es: {
            ...
            modal: {
                ...
                privacy: {
                    ...
                    choice: "Si decide conectar su Google Calendar, solicitamos acceso a su cuenta de Google a través de OAuth. Específicamente, solicitamos el siguiente alcance de Google: https://www.googleapis.com/auth/calendar.events",
                    data: "2. Cómo usamos sus datos",
                    permission: "Usamos este permiso solo para crear, actualizar o eliminar eventos del calendario que representan sus notas personales. No accedemos, almacenamos ni analizamos ningún otro evento en su calendario.",
                    storage: "3. Almacenamiento de datos",
                    token: "Sus tokens OAuth se almacenan de forma segura en nuestros servidores o en cookies seguras, y nunca se comparten con terceros.",
                    compliance: "4. Cumplimiento de uso limitado",
                    requirements: "El uso de las API de Google por parte de nuestra aplicación se adhiere a los requisitos de uso limitado de Google: solo accedemos a la información necesaria para proporcionar las funciones que solicita explícitamente, y nunca compartimos sus datos.",
                    contact: "5. Contacto",
                    questions: "Si tiene preguntas sobre esta Política de Privacidad, puede contactarnos en",
                    back: "Volver"
                },
                terms: {
